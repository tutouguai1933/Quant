    ...
    def infer(self, dataset: dict[str, object]) -> dict[str, object]:
            ...
            candidates.append(
                {
                    ...
                    "ml_prediction": ml_prediction_data,
                    "validation": per_symbol_validation,
                    "backtest_row_info": {
        ...
        ranked_candidates = rank_candidates(
            ...
            thresholds={
                ...
                "enable_ml_live_gate": self._config.enable_ml_live_gate,
                "live_min_ml_probability": self._config.live_min_ml_probability,
        ...
        *,
        ...
        return {
            ...
            "input_summary": {
                ...
                "enable_live_gate": self._config.enable_live_gate,
                "enable_ml_live_gate": self._config.enable_ml_live_gate,
                "live_min_ml_probability": str(self._config.live_min_ml_probability),
