...
class ApiSkeletonTests(unittest.TestCase):
    ...
    def test_automation_routes_return_consistent_response_shape(self) -> None:
        ...
        self.assertIn("arbitration", status["data"]["item"])
        self.assertIn("status", status["data"]["item"]["arbitration"])
        self.assertIn("suggested_action", status["data"]["item"]["arbitration"])
        self.assertIn("inputs", status["data"]["item"]["arbitration"])
