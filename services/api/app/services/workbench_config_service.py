...
class WorkbenchConfigService:
    ...
    def _normalize_thresholds_section(self, value: object) -> dict[str, object]:
        ...
        return {
            ...
            "rule_min_volume_ratio": self._normalize_decimal(payload.get("rule_min_volume_ratio"), default=Decimal("0.8"), minimum=Decimal("0")),
            ...
            "strict_rule_min_volume_ratio": self._normalize_decimal(payload.get("strict_rule_min_volume_ratio"), default=Decimal("0.85"), minimum=Decimal("0")),
