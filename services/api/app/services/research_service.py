    ...
    def _build_config_alignment(
        *,
        ...
        current_pairs = {
            ...
            "label_trigger_basis": str(research_config.get("label_trigger_basis", "")),
            "label_target_pct": str(research_config.get("label_target_pct", "")),
            "label_stop_pct": str(research_config.get("label_stop_pct", "")),
            "holding_window_label": str(research_config.get("holding_window_label", "")),
            ...
            "force_validation_top_candidate": str(bool(research_config.get("force_validation_top_candidate", False))).lower(),
            ...
            "timeframe_profiles": json.dumps(dict(features_config.get("timeframe_profiles") or {}), ensure_ascii=False, sort_keys=True),
            ...
            "backtest_cost_model": str(backtest_config.get("cost_model", "")),
            "train_split_ratio": str(research_config.get("train_split_ratio", "")),
            "validation_split_ratio": str(research_config.get("validation_split_ratio", "")),
            "test_split_ratio": str(research_config.get("test_split_ratio", "")),
            "signal_confidence_floor": str(research_config.get("signal_confidence_floor", "")),
            "trend_weight": str(research_config.get("trend_weight", "")),
            "momentum_weight": str(research_config.get("momentum_weight", "")),
            "volume_weight": str(research_config.get("volume_weight", "")),
            "oscillator_weight": str(research_config.get("oscillator_weight", "")),
            "volatility_weight": str(research_config.get("volatility_weight", "")),
            "strict_penalty_weight": str(research_config.get("strict_penalty_weight", "")),
            "primary_factors": json.dumps(list(features_config.get("primary_factors") or []), ensure_ascii=False),
            "auxiliary_factors": json.dumps(list(features_config.get("auxiliary_factors") or []), ensure_ascii=False),
            ...
            "dry_run_min_win_rate": str(thresholds_config.get("dry_run_min_win_rate", "")),
            "dry_run_max_turnover": str(thresholds_config.get("dry_run_max_turnover", "")),
            "dry_run_min_sample_count": str(thresholds_config.get("dry_run_min_sample_count", "")),
            "validation_min_sample_count": str(thresholds_config.get("validation_min_sample_count", "")),
            "validation_min_avg_future_return_pct": str(thresholds_config.get("validation_min_avg_future_return_pct", "")),
            "consistency_max_validation_backtest_return_gap_pct": str(
                thresholds_config.get("consistency_max_validation_backtest_return_gap_pct", "")
            ),
            "consistency_max_training_validation_positive_rate_gap": str(
                thresholds_config.get("consistency_max_training_validation_positive_rate_gap", "")
            ),
            "consistency_max_training_validation_return_gap_pct": str(
                thresholds_config.get("consistency_max_training_validation_return_gap_pct", "")
            ),
            "rule_min_ema20_gap_pct": str(thresholds_config.get("rule_min_ema20_gap_pct", "")),
            "rule_min_ema55_gap_pct": str(thresholds_config.get("rule_min_ema55_gap_pct", "")),
            "rule_max_atr_pct": str(thresholds_config.get("rule_max_atr_pct", "")),
            "rule_min_volume_ratio": str(thresholds_config.get("rule_min_volume_ratio", "")),
            "strict_rule_min_ema20_gap_pct": str(thresholds_config.get("strict_rule_min_ema20_gap_pct", "")),
            "strict_rule_min_ema55_gap_pct": str(thresholds_config.get("strict_rule_min_ema55_gap_pct", "")),
            "strict_rule_max_atr_pct": str(thresholds_config.get("strict_rule_max_atr_pct", "")),
            "strict_rule_min_volume_ratio": str(thresholds_config.get("strict_rule_min_volume_ratio", "")),
            "enable_rule_gate": str(bool(thresholds_config.get("enable_rule_gate", True))).lower(),
            "enable_validation_gate": str(bool(thresholds_config.get("enable_validation_gate", True))).lower(),
            "enable_backtest_gate": str(bool(thresholds_config.get("enable_backtest_gate", True))).lower(),
            "enable_consistency_gate": str(bool(thresholds_config.get("enable_consistency_gate", True))).lower(),
            "enable_live_gate": str(bool(thresholds_config.get("enable_live_gate", True))).lower(),
            ...
            "live_min_win_rate": str(thresholds_config.get("live_min_win_rate", "")),
            "live_max_turnover": str(thresholds_config.get("live_max_turnover", "")),
        ...
        runtime_pairs = {
            ...
            "label_trigger_basis": str(training_parameters.get("label_trigger_basis", input_summary.get("label_trigger_basis", ""))),
            "label_target_pct": str(training_parameters.get("label_target_pct", "")),
            "label_stop_pct": str(training_parameters.get("label_stop_pct", "")),
            "holding_window_label": str(training_parameters.get("holding_window_label", input_summary.get("holding_window_label", ""))),
            ...
            "force_validation_top_candidate": str(training_parameters.get("force_validation_top_candidate", input_summary.get("force_validation_top_candidate", ""))).lower(),
            ...
            "timeframe_profiles": json.dumps(
                dict(training_parameters.get("timeframe_profiles") or input_summary.get("timeframe_profiles") or {}),
                ensure_ascii=False,
                sort_keys=True,
            ),
            ...
            "backtest_cost_model": str(training_parameters.get("backtest_cost_model", input_summary.get("backtest_cost_model", ""))),
            "train_split_ratio": str(training_parameters.get("train_split_ratio", input_summary.get("train_split_ratio", ""))),
            "validation_split_ratio": str(training_parameters.get("validation_split_ratio", input_summary.get("validation_split_ratio", ""))),
            "test_split_ratio": str(training_parameters.get("test_split_ratio", input_summary.get("test_split_ratio", ""))),
            "signal_confidence_floor": str(training_parameters.get("signal_confidence_floor", input_summary.get("signal_confidence_floor", ""))),
            "trend_weight": str(training_parameters.get("trend_weight", input_summary.get("trend_weight", ""))),
            "momentum_weight": str(training_parameters.get("momentum_weight", input_summary.get("momentum_weight", ""))),
            "volume_weight": str(training_parameters.get("volume_weight", input_summary.get("volume_weight", ""))),
            "oscillator_weight": str(training_parameters.get("oscillator_weight", input_summary.get("oscillator_weight", ""))),
            "volatility_weight": str(training_parameters.get("volatility_weight", input_summary.get("volatility_weight", ""))),
            "strict_penalty_weight": str(training_parameters.get("strict_penalty_weight", input_summary.get("strict_penalty_weight", ""))),
            "primary_factors": json.dumps(list(training_parameters.get("primary_factors") or input_summary.get("primary_factors") or []), ensure_ascii=False),
            "auxiliary_factors": json.dumps(list(training_parameters.get("auxiliary_factors") or input_summary.get("auxiliary_factors") or []), ensure_ascii=False),
            ...
            "dry_run_min_win_rate": str(input_summary.get("dry_run_min_win_rate", "")),
            "dry_run_max_turnover": str(input_summary.get("dry_run_max_turnover", "")),
            "dry_run_min_sample_count": str(input_summary.get("dry_run_min_sample_count", "")),
            "validation_min_sample_count": str(input_summary.get("validation_min_sample_count", "")),
            "validation_min_avg_future_return_pct": str(input_summary.get("validation_min_avg_future_return_pct", "")),
            "consistency_max_validation_backtest_return_gap_pct": str(
                input_summary.get("consistency_max_validation_backtest_return_gap_pct", "")
            ),
            "consistency_max_training_validation_positive_rate_gap": str(
                input_summary.get("consistency_max_training_validation_positive_rate_gap", "")
            ),
            "consistency_max_training_validation_return_gap_pct": str(
                input_summary.get("consistency_max_training_validation_return_gap_pct", "")
            ),
            "rule_min_ema20_gap_pct": str(input_summary.get("rule_min_ema20_gap_pct", "")),
            "rule_min_ema55_gap_pct": str(input_summary.get("rule_min_ema55_gap_pct", "")),
            "rule_max_atr_pct": str(input_summary.get("rule_max_atr_pct", "")),
            "rule_min_volume_ratio": str(input_summary.get("rule_min_volume_ratio", "")),
            "strict_rule_min_ema20_gap_pct": str(input_summary.get("strict_rule_min_ema20_gap_pct", "")),
            "strict_rule_min_ema55_gap_pct": str(input_summary.get("strict_rule_min_ema55_gap_pct", "")),
            "strict_rule_max_atr_pct": str(input_summary.get("strict_rule_max_atr_pct", "")),
            "strict_rule_min_volume_ratio": str(input_summary.get("strict_rule_min_volume_ratio", "")),
            "enable_rule_gate": str(input_summary.get("enable_rule_gate", "")).lower(),
            "enable_validation_gate": str(input_summary.get("enable_validation_gate", "")).lower(),
            "enable_backtest_gate": str(input_summary.get("enable_backtest_gate", "")).lower(),
            "enable_consistency_gate": str(input_summary.get("enable_consistency_gate", "")).lower(),
            "enable_live_gate": str(input_summary.get("enable_live_gate", "")).lower(),
            ...
            "live_min_win_rate": str(input_summary.get("live_min_win_rate", "")),
            "live_max_turnover": str(input_summary.get("live_max_turnover", "")),
            "live_min_sample_count": str(input_summary.get("live_min_sample_count", "")),
        }
