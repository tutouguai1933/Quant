...
- 当前正在做：`Phase2` 长期运行收口，A1 / A2 / A3 / A4 / A5 / B1 / B2 / B3 / B4 / B5 / C1 / C2 已完成，下一步进入 C3 人工接管收口。
- 上次停留位置：任务页现在会直接说明“系统在等什么 / 为什么现在不能恢复 / 恢复和继续下一轮不是一回事”。
...
- 进入 C3：把人工接管入口和恢复路径继续收顺手
- 然后推进 C4：把长期运行摘要继续收成更稳定的健康结论
