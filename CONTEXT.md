...
- 当前正在做：`Phase2` 长期运行收口，A1 / A2 / A3 / A4 / A5 / B1 / B2 / B3 / B4 / B5 / C1 已完成，下一步进入 C2 调度与恢复收口。
- 上次停留位置：任务页现在会直接用人话说明“最近发生了什么 / 你现在该做什么”，不再主要靠告警 code 和 level 判断。
...
- 进入 C2：把调度和恢复流程收成更稳定的等待 / 恢复口径
- 然后推进 C3：把人工接管入口和恢复路径继续收顺手
